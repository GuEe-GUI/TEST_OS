...
;   File:       CMOS.asm
;
;   Contains:   Interfaces controller in assembly
;
;   Written by: GUI
;
...
GET_TIME :
    mov al,0x0a         ;Blocking NMI RTC register A (The 7th UIP One)
    or al,0x80
    out 0x70,al
    ...
    ; mov al,0x0c         ;RTC register (c) develop NMI
    ; out 0x70,al
    ; in al,0x71          ;Read RTC register (c) once or There's only one Interruption
